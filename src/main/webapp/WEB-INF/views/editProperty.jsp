...
<html lang="en">
  	<head>
	    ...
	    <title>ChainlinkPrototype - EDIT PROPERTY</title>
	    <style>
	    	body{
	...
	<body>
		<div class="m-3">
			...
			<form:form action="/ChainlinkPrototype/addProperty" method="post" modelAttribute="newPropertyForm" enctype="multipart/form-data">
						    	...
						    	<div class="row">
							    	<div class="col">
							    		<div class="form-group ">
							    			<form:hidden path="id" value="${property.id}"/>
							    			...
							    			<form:input path="propName" class="form-control" placeholder="Property Name" type="text" Required="required" value="${property.propName}"/>
							    		</div>
							    		<div class="form-group ">
				  				...
				  				<div class="row">
				  					<div class="col">
				  						<div class="form-group ">
								    		...
								    		<form:input path="metaSong" class="form-control" placeHolder="Song Title" type="text" value="${property.metaSong}" />
							    		</div>
							    		<div class="form-group ">
							    			<form:label path="metaArtist">Artist</form:label>
								    		<form:input path="metaArtist" class="form-control" placeHolder="Artist" type="text" value="${property.metaArtist}"/>
							    		</div>
							    		<div class="form-group ">
							    			<form:label path="metaAlbum">Album</form:label>
								    		<form:input path="metaAlbum" class="form-control" placeHolder="Album" type="text" value="${property.metaAlbum}"/>
							    		</div>
							    		<div class="form-group ">
							    			<form:label path="metaAlbumArtist">Album Artist</form:label>
								    		<form:input path="metaAlbumArtist" class="form-control" placeHolder="Album Artist" type="text" value="${property.metaAlbumArtist}"/>
							    		</div>
							    		<div class="form-group ">
							    			<form:label path="metaComposer">Composer</form:label>
								    		<form:input path="metaComposer" class="form-control" placeHolder="Composer" type="text" value="${property.metaComposer}"/>
							    		</div>
							    		<div class="form-group ">
							    			<form:label path="metaGrouping">Grouping</form:label>
								    		<form:input path="metaGrouping" class="form-control" placeHolder="Grouping" type="text" value="${property.metaGrouping}"/>
							    		</div>
							    		<div class="form-group ">
							    			<form:label path="metaGenre">Genre</form:label>
								    		<form:input path="metaGenre" class="form-control" placeHolder="Genre" type="text" value="${property.metaGenre}"/>
							    		</div>
							    		<div class="form-group ">
							    			<form:label path="metaYear">Year</form:label>
								    		<form:input path="metaYear" class="form-control" placeHolder="Year" type="text" value="${property.metaYear}"/>
							    		</div>
							    		<div class="form-group ">
							    			<form:label path="metaBpm">BPM</form:label>
								    		<form:input path="metaBpm" class="form-control" placeHolder="BPM" type="text" value="${property.metaBpm}"/>
							    		</div>
							    		<div class="form-group ">
